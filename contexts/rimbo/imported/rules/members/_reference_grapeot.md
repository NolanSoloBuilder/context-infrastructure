# _reference_grapeot.md - 上游 grapeot 的个人 profile（参考用）

_这是上游 context infrastructure 原作者 grapeot 的个人 profile，保留作为 member profile 写法的参考样本。**默认不加载**——只有当 caller 明确询问「鸭哥怎么看」或想参考 profile 写法时才查阅。新成员请按 `_template.md` 创建自己的 `<handle>.md`，不要 fork 这份。_
