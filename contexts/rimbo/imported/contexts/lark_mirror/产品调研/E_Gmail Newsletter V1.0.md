<!-- lark-mirror obj_token=IbjqdGKJToGWVoxv1b9jWHmspsg space=产品调研 synced=2026-05-18T07:54:44Z -->

# E_Gmail Newsletter V1.0
...
ecosystem signals
For each card, produce a full landing page with properly written synthesis.
...
```Plain Text
user_prompt = """
You will recevie the message list:
{user's profile} {gmail's }
"""
```
...
{
  "inbox_brief": "<string>",   # 全部gmail邮件内容卡片的引导语
  "cards": [
    {
      "card_id": "theme_01",
      "icon": "inbox",
      "card_type": "inbox_must_read", # 卡片类型，暂时为gmail_digest
      "title": "<8–16 words>", # 卡片标题
      "subtitle": "<≤40 words incl. key senders>", # 卡片封面的简要说明
      "card_data":{ 
          ...
          "relevance": "<≤70 words>", # 这封卡片对用户的关联
          "suggested_actions": [。       
            "<optional next step #1>",  # 对用户的建议
